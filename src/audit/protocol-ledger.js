...
const THREAD_SETTLED_EXAMPLES = Object.freeze([
  ...
  {
    id: "dkp-2026-07-21-001",
    date: "2026-07-21",
    time: "00:19:53 ET",
    sport: "MLB",
    league: "MLB",
    game: "TB Rays @ TOR Blue Jays / DET Tigers @ CHC Cubs",
    team_or_player: "Dylan Cease + Alex Bregman",
    market_type: "parlay",
    market_name: "Cease over 6.5 strikeouts + Bregman over 1.5 total bases",
    line: "",
    odds: 233,
    stake: 9.92,
    payout: 31,
    status: "won",
    pregame_or_live: "pregame",
    source_type: "authenticated_draftkings_predictions_settlement",
    source_file: "data/evidence/draftkings_predictions_settled_2026-07-21.json",
    source_frame_or_screenshot: "DKP3-122AB77E26824B30818E8354A40FCC24-CMB",
    confidence: "low",
    process_grade: "D",
    mistake_tags: ["parlay_unnecessary"],
    notes: "Won, bought $9.92 and paid $31.00. Both legs settled correctly. Account result only: no exact pre-registered Bear Edge evaluation matched both events and markets."
  },
  {
    id: "dkp-2026-07-21-002",
    date: "2026-07-21",
    time: "00:29:52 ET",
    sport: "MLB",
    league: "MLB",
    game: "STL Cardinals @ LAA Angels",
    team_or_player: "LAA Angels",
    market_type: "MLB_side",
    market_name: "Angels ML",
    line: "",
    odds: 223,
    stake: 1.98,
    payout: 0.9,
    status: "lost",
    pregame_or_live: "live",
    source_type: "authenticated_draftkings_predictions_settlement",
    source_file: "data/evidence/draftkings_predictions_settled_2026-07-21.json",
    source_frame_or_screenshot: "DKP3-SPMLBGLMLXAOUZ2ENU17QLD1ICV1VFG-WXAOUZ2GZ617QLEMALBH0",
    confidence: "low",
    process_grade: "C",
    mistake_tags: [],
    notes: "Closed early for $0.90 after buying for $1.98, a realized loss of $1.08. The Angels later won, but the recorded trade result is the realized financial loss. No exact pre-registered Bear Edge evaluation matched this market."
  },
  {
    id: "dkp-2026-07-21-003",
    date: "2026-07-21",
    time: "00:57:46 ET",
    sport: "MLB",
    league: "MLB",
    game: "ATH Athletics @ ARI Diamondbacks",
    team_or_player: "ATH Athletics",
    market_type: "MLB_runline",
    market_name: "Athletics -1.5",
    line: -1.5,
    odds: 213,
    stake: 2.72,
    payout: 8,
    ...
    source_type: "authenticated_draftkings_predictions_settlement",
    source_file: "data/evidence/draftkings_predictions_settled_2026-07-21.json",
    source_frame_or_screenshot: "DKP3-SPMLBGLSPRXAOVGGVWI180YCWMK655FG-W-1.5XAOVGGVWI180YCZQ2CQF",
    confidence: "low",
    process_grade: "C",
    mistake_tags: [],
    notes: "Won, bought $2.72 and paid $8.00. Account result only: no exact pre-registered Bear Edge evaluation matched this run line."
  },
  {
    id: "dkp-2026-07-21-004",
    date: "2026-07-21",
    time: "20:24:02 ET",
    sport: "MLB",
    league: "MLB",
    game: "SD Padres @ ATL Braves",
    team_or_player: "Reynaldo Lopez",
    market_type: "MLB_pitcher_K",
    market_name: "Under 4.5 strikeouts",
    line: 4.5,
    odds: -127,
    stake: 4.64,
    payout: 0,
    ...
    source_type: "authenticated_draftkings_predictions_settlement",
    source_file: "data/evidence/draftkings_predictions_settled_2026-07-21.json",
    source_frame_or_screenshot: "DKP3-SPMLBPPTPSXAOY941JM19OVHI8YNFMCMV5BMFSZG8TBG9WZXOFG-U4.5XAOY941JM19OVHJXNS24",
    confidence: "low",
    process_grade: "C",
    mistake_tags: [],
    notes: "Lost $4.64. Bear Edge evaluated Reynaldo Lopez over 2.5, not this under 4.5 market, so this is not an algorithm-validation result."
  },
  {
    id: "dkp-2026-07-21-005",
    date: "2026-07-21",
    time: "22:20:51 ET",
    sport: "MLB",
    league: "MLB",
    game: "SD Padres @ ATL Braves",
    team_or_player: "Drake Baldwin",
    market_type: "MLB_HR",
    market_name: "Over 0.5 home runs",
    line: 0.5,
    odds: 426,
    stake: 5,
    payout: 0,
    ...
    source_type: "authenticated_draftkings_predictions_settlement",
    source_file: "data/evidence/draftkings_predictions_settled_2026-07-21.json",
    source_frame_or_screenshot: "DKP3-SPMLBPPTHRMXAOY96T2Y19OX4VR846JZHJHA2UTYMFSZHDPBGFG-O0.5XAOY96T2Y19OX50T6SMC",
    confidence: "low",
    process_grade: "C",
    mistake_tags: [],
    notes: "Lost $5.00. Account result only: no exact pre-registered Bear Edge evaluation matched this home-run market."
  },
  {
    id: "dkp-2026-07-21-006",
    date: "2026-07-21",
    time: "22:48:38 ET",
    sport: "MLB",
    league: "MLB",
    game: "MIA Marlins @ HOU Astros",
    team_or_player: "MIA Marlins",
    market_type: "MLB_side",
    market_name: "Marlins ML",
    line: "",
    odds: 113,
    stake: 7.84,
    payout: 0,
    ...
    source_type: "authenticated_draftkings_predictions_settlement",
    source_file: "data/evidence/draftkings_predictions_settled_2026-07-21.json",
    source_frame_or_screenshot: "DKP3-SPMLBGLMLXAOWEHW7M18L7P4B5M05FG-WXAOWEHYIY18L7QMGGZRT",
    confidence: "low",
    process_grade: "C",
    mistake_tags: ["duplicate_exposure"],
    notes: "Lost $7.84. The same Marlins side was repeated in a combo. No exact pre-registered Bear Edge evaluation matched this moneyline."
  },
  {
    id: "dkp-2026-07-21-007",
    date: "2026-07-21",
    time: "22:48:44 ET",
    sport: "MLB",
    league: "MLB",
    game: "MIA Marlins @ HOU Astros",
    team_or_player: "MIA Marlins + Tyler Phillips",
    market_type: "parlay",
    market_name: "Marlins ML + Phillips under 3.5 strikeouts",
    line: "",
    odds: 300,
    stake: 4.86,
    payout: 0,
    ...
    source_type: "authenticated_draftkings_predictions_settlement",
    source_file: "data/evidence/draftkings_predictions_settled_2026-07-21.json",
    source_frame_or_screenshot: "DKP3-8E3E470553E74E0CAAAF8D58B394E85A-CMB",
    confidence: "low",
    process_grade: "D",
    mistake_tags: ["parlay_unnecessary", "duplicate_exposure"],
    notes: "Lost $4.86 because the Marlins leg failed; Phillips under 3.5 settled correctly. Both legs duplicated single-position exposure. No exact Bear Edge evaluation matched the combo."
  },
  {
    id: "dkp-2026-07-21-008",
    date: "2026-07-21",
    time: "22:49:18 ET",
    sport: "MLB",
    league: "MLB",
    game: "MIA Marlins @ HOU Astros",
    team_or_player: "Tyler Phillips",
    market_type: "MLB_pitcher_K",
    market_name: "Under 3.5 strikeouts",
    line: 3.5,
    odds: -113,
    stake: 12.18,
    payout: 22,
    ...
    source_type: "authenticated_draftkings_predictions_settlement",
    source_file: "data/evidence/draftkings_predictions_settled_2026-07-21.json",
    source_frame_or_screenshot: "DKP3-SPMLBPPTPSXAOY9YUCA19PDU09KAYBDHLSZXITCGHPBGXPCHMFG-U3.5XAOY9YUCA19PDU1B33L9",
    confidence: "low",
    process_grade: "C",
    mistake_tags: ["duplicate_exposure"],
    notes: "Won, bought $12.18 across two pregame orders and paid $22.00. Bear Edge evaluated Tyler Phillips over 2.5, not this under 3.5 market, so this is not an algorithm-validation result."
  }
]);
