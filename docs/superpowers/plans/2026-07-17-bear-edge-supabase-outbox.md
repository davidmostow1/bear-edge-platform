...
- [ ] **Step 3: Implement the outbox event contract**
...
- [ ] **Step 4: Enqueue after authoritative append**
...
- [ ] **Step 3: Implement decision mapping**
...
- [ ] **Step 4: Implement settlement and amendment mapping**
...
- [ ] **Step 1: Recheck remote row counts and schema**
...
- [ ] **Step 1: Write safe-configuration tests**
...
- [ ] **Step 4: Verify duplicate digest semantics**
...
- [ ] **Step 1: Write retry and restart tests**
...
- [ ] **Step 6: Run Plan 2 verification and commit**
