...
6. Every committed archive file is listed in `manifest.json` and `SHA256SUMS.txt`.
7. GitHub files are refetched after upload.
...
- **File library:** canonical coordination, Kalishi handoff/audit, and screenshot-ledger documents checked.
